...
* Visualizations used in my classes --
  * My sophomore-level astrophysics class for physics majors and interested non-majors:  Kepler's laws (https://github.com/rtfisher/keplers_laws_animation), conic sections (https://github.com/rtfisher/conic_sections_visualization), and exoplanet transit visualizer (https://github.com/rtfisher/exoplanet-transit-visualization)
