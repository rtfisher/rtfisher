...
* Visualizations used in my classes -- most notably from my junior-level undergraduate physics major class, illustrating forced, damped, harmonic and anharmonic oscillators (https://github.com/rtfisher/forced_damped_oscillator), normal modes of coupled harmonic oscillators (https://github.com/rtfisher/normal_modes), and torque-free rotation of a rigid body (https://github.com/rtfisher/torque-free-rigid-rotation)
