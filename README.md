...
* Visualizations used in my classes --
  ...
  * My sophomore-level modern physics class: the Galilean and Lorentz transformations (https://github.com/rtfisher/galilean_lorentz_visualizations), the photoelectric effect (https://github.com/rtfisher/photoelectric-animation)
